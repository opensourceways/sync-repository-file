module github.com/opensourceways/sync-repository-file

go 1.18

require (
	github.com/opensourceways/kafka-lib v0.0.0-20230406092848-cefa19b4d680
	github.com/opensourceways/repo-file-cache v0.0.0-20221229074015-76117b47047e
...
require (
	...
	github.com/opensourceways/community-robot-lib v0.0.0-20221212062947-85a66b110688 // indirect
